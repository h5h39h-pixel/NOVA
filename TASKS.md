...
| IDEA‑2b | **Screen‑memory retention policy** — auto‑expire old screen‑memory docs + a "purge screen memories" button (discovered in M105d: IDEA‑2 persists screen text with no cap) | P2 | ⬜ |
