...
| HON‑2b | Reliable GUI integration test with an isolated disposable app | P2 | ⬜ | UWP Notepad is unsafe/flaky for this; use a throwaway app (own window, no session restore) so find→click→type→verify is deterministic and non‑destructive. |
